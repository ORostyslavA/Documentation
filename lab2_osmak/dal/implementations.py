        ...
        with open(file_path, 'r', encoding='utf-8') as file:
            ...
            for row in reader:
                ...
                if entity_type == 'user':
                    ...
                    output_strategy.output_message(f"Imported user: {user.name} ({user.email})")
                    ...
                    output_strategy.output_message(f"Imported tester: user_id={tester.user_id}, experience={tester.experience_years}")
                    ...
                    output_strategy.output_message(f"Imported test plan: {test_plan.name}")
                    ...
                    output_strategy.output_message(f"Imported test case: {test_case.name}")
                    ...
                    output_strategy.output_message(f"Imported test step: {test_step.description}")
                    ...
                    output_strategy.output_message(f"Imported test result: status={test_result.status.value}")